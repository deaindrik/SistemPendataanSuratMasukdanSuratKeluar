			...
			<div class="col-sm-7">
				<div class="panel panel-body">
					...
					<p>
						...
						<p class="adr clearfix">
							<span class="adr-group">
								<span class="street-address">JL. Raya Pati-Tayu</span><br>
								<span class="postal-code">59154</span><br>
								<span class="country-name">Kajen, Margoyoso, Kabupaten Pati, Jawa Tengah</span>
							</span>
						</p>
					</p>
					<hr />
					<p>
						...
						<span class="editContent"> (0295) 452011</span>
					</p>
					<hr />

					<p>
						<b class="chead"><span class="material-icons">email</span> Email</b><br />
						<a href="#" class="editContent">kecamatanmargoyoso@gmail.com</a>
					</p>
				</div>
			</div>
		</div>
